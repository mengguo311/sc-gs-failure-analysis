...
D-NeRF scenes with distinct limb geometries, progressive scheduling closes
43--80\% of the rigidity gap between the original and reference modes, with
strictly monotone improvement in the schedule length on almost all scenes. All
...
(Fig.~\ref{fig:beforeafter}, top row) the limb \emph{under-rotates} --- at
...
\begin{figure}[t]
  ...
  \caption{\textbf{Original SC-GS vs.\ our method, qualitative before/after}
  (\texttt{jumpingjacks}, 45$^\circ$/90$^\circ$/135$^\circ$). Top to bottom:
  \scgsOrig{}, \ours{4}, \ours{8}, \scgsIter{} (reference). The original
  mode's arm under-rotates and its hand shreds from 60$^\circ$; \ours{8}
  tracks the reference through 90$^\circ$ at 1/16 of its cost.}
...
\begin{table*}[t]
  ...
  \begin{tabular}{lccccc}
    ...
    \midrule
    \scgsOrig{}          & .189 / .269 & .213 / .318 & .237 / .399 & .362 / .439 & .285 / .410 \\
    \ours{2}             & .174 / .271 & .201 / .285 & .211 / .337 & .344 / .409 & .295 / .421 \\
    \ours{4}             & .140 / .207 & .169 / .228 & .177 / .258 & .310 / .389 & .285 / .391 \\
    \ours{8}             & .108 / .112 & .134 / .175 & .135 / .221 & .261 / .307 & .267 / .371 \\
    \scgsIter{} (slow ref.) & .074 / .072 & .088 / .125 & .109 / .157 & .165 / .181 & .244 / .342 \\
    \bottomrule
  \end{tabular}
\end{table*}
...
\begin{figure*}[t]
  ...
  easiest-to-see cases. Columns, left to right: \scgsOrig{}, \ours{4},
  \ours{8}, \scgsIter{} (reference). Top: \texttt{jumpingjacks} --- the
  original mode leaves the arm near-horizontal with a shredded hand; our
  schedules progressively restore the intended lowered pose. Bottom:
  \texttt{trex} --- the original mode shortens and kinks the tail; ours
  restores the smooth arc.}
...
\scgsOrig{} $>$ \ours{2} $>$ \ours{4} $>$ \ours{8} $>$ reference is
\textbf{strictly monotone at every tested angle} (Tab.~\ref{tab:crossscene},
Fig.~\ref{fig:crossscene}); at 90$^\circ$ \ours{8} closes 71\% / 63\% / 80\% /
51\% / 43\% of the original$\rightarrow$reference gap
