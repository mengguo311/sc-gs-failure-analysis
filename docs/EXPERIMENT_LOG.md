...
| 26 | 2026-07-29 | Train+eval hellwarrior, lego, bouncingballs n512 | queue3 (outputs/queue3.log) | outputs/*_n512_node | hellwarrior 43.00 (paper 42.93, +0.07); bouncingballs 42.55 (paper 44.91, −2.36, investigated: best-ckpt 42.61, LPIPS better than paper); lego 25.36 (no paper value; misaligned D-NeRF test split, editing-only) |
| 27 | 2026-07-29 | Cross-scene Failure A + improvement: hellwarrior (spread arm, axis Y, cam 6), lego (shovel hinge, axis X, cam 9), bouncingballs (ball on arc, axis Y, cam 8) | scripts/edit_headless.py | results/failureA/{hellwarrior,lego,bouncingballs} | ordering monotone; N8 gap closure @90°: 79% / 67% / 72%; bouncingballs proves failure needs no articulated chain |
| 28 | 2026-07-29 | 8-scene cross summary + all figures regenerated with contrastive labels | scripts/cross_scene_summary.py, paper_figures.py | results/failureA/cross_scene_*, paper/figures/ | N8 gap closure range 43–80% over 8 scenes |
| 29 | 2026-07-29 | Paper revision: contrastive captions, titlesec typography, 8-scene tables, recompiled PDF (10 pp) | paper/paper.tex | paper/paper.pdf | deep-review fixes incl. duplicate-period headings |
